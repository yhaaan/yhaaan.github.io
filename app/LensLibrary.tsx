...
const STORAGE_KEY = "jesse-lenses:data:v1";
...
export function LensLibrary() {
  const [lenses, setLenses] = useState<LensCard[]>(createEmptyLibrary);
  ...
  return (
    <main className="app-shell">
      ...
      <section className="workspace" aria-label="렌즈 검색과 목록">
        ...
        <aside className="privacy-note">
          <div>
            ...
            <p><strong>이 브라우저에만 저장됩니다.</strong> 다른 기기나 시크릿 모드에는 동기화되지 않아요.</p>
          </div>
          <button
            type="button"
      ...
      <footer className="footer">
        <p>UNOFFICIAL PERSONAL STUDY TOOL</p>
        <span>입력한 내용은 서버로 전송되지 않습니다.</span>
